...
<head>
    ...
    <title>Forgot Password | Admin | <?php echo env('APP_NAME'); ?></title>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="h5 modal-title text-center">
                                            <h4 class="mt-2">
                                                <div><?php echo trans('login.forgot_password'); ?></div>
                                            </h4>
                                        </div>
                                        ...
                                        <h6 class="mb-0"><a href="<?php echo url('admin/login'); ?>" class="text-primary" style="font-size:14px;"><?php echo trans('login.login_now'); ?></a></h6>
                                    </div>
                                    <div class="modal-footer clearfix">
                                        <!--<div class="float-left"><a href="javascript:void(0);" class="btn-lg btn btn-link">Forgot Password?</a></div>-->
                                        <div class="float-right">
                                            <button class="btn btn-primary btn-lg"><?php echo trans('login.submit'); ?></button>
                                        </div>
                                    </div>
                                        </form>
                                </div>
